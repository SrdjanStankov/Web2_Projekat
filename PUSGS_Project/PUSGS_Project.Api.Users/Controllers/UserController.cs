...
namespace PUSGS_Project.Api.Users.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        {
            var user = MapUser(model, settings.RequireEmailVerification);
        ...
        {
            var clientUrl = settings.Client_URL;
            const string subject = "Email verification";
            var body = $"<p>For: {email}</p><a href=\"{clientUrl}/ConfirmEmail/{email}\">Confirm Email</a>";
        ...
        private static T MapUser<T>(User model, bool requireEmailVerification = true, bool requirePasswordChange = false) where T : User, new() => new T()
        {
            City = model.City,
            Email = model.Email,
